    ...
    <body>
        ...
        <div class="container-fluid">
                <a class="btn btn-primary" href="" role="button" data-bs-toggle="modal" data-bs-target="#add">Tambah Data</a>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="proses.php?id=<?php echo $row['idsiswa']; ?>" class="btn btn-primary">Delete</a></td>
                    </tr>
                    <?php
                        $no++;
                        }
